...
# 색상 리스트
color = ("BRIGHTRED","BRIGHTGREEN","BRIGHTBLUE","BLUE","BRIGHTYELLOW")
...
def increase_score():
    global SCORE, STAGE, STAGESCORE, BESTSCORE,color_nm
...
def main():
    global SCREEN, CAR_COUNT, WINDOW_WIDTH, WINDOW_HEIGHT, PNUMBER, SCORE, BESTSCORE, OIL_CK, STAGE, STAGESCORE, STAGESTAIR, color_nm
    ...
    while playing:
        ...
        if color_nm == 0:
            ...
            SCREEN.fill(BRIGHTRED)
        elif color_nm == 2:
            SCREEN.fill(BRIGHTGREEN)
        elif color_nm == 3:
            SCREEN.fill(BRIGHTBLUE)
        elif color_nm == 4:
            SCREEN.fill(BRIGHTYELLOW)
